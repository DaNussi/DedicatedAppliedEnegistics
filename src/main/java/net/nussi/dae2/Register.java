...
public class Register {
    ...
    public static final Supplier<MenuType<InterDimensionalInterfaceMenu>> INTER_DIMENSIONAL_INTERFACE_BLOCK_MENU = MENU_TYPES.register("inter_dimensional_interface", () -> IMenuTypeExtension.create(InterDimensionalInterfaceMenu::new));
